...
"}")
        ...
        self.retLogin.setText("返回主界面")
        self.retLogin.setStyleSheet("background:none;color:white;border:none;font-size:25px;font-weight:bold;")
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(-1)
...
# "")
        ...
        # self.label_5.setGeometry(QtCore.QRect(670, 540, 121, 31))
