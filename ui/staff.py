...
"}")
        ...
        self.inputdate.setDateTime(QtCore.QDateTime(QtCore.QDate.currentDate(), QtCore.QTime(0, 0, 0)))
...
"}")
        ...
        self.refresh = QtWidgets.QPushButton(self.page_4)
        self.refresh.setObjectName("refresh")
        self.refresh.setGeometry(QtCore.QRect(340, 210, 93, 28))
        self.refresh.setStyleSheet("#refresh{background:#CCFFCC;\n"
                                    "border-radius:8px}\n"
                                    "#refresh:hover\n"
                                    "{\n"
                                    "background:#CCFF99\n"
...
"border-radius:5px")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sname.setText(_translate("MainWindow", "邢明炜"))
        self.ssex.setText(_translate("MainWindow", "男"))
        self.stime.setText(_translate("MainWindow", "1999-12-5"))
