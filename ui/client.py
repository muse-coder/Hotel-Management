...
"")
        ...
        self.tableClient.setColumnCount(8)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tableClient.setHorizontalHeaderItem(7, item)
...
"}")
        ...
        self.cage = QtWidgets.QLineEdit(self.page_2)#QLineEdit是一个单行文本编辑控件。
        ...
        self.label_14.setGeometry(QtCore.QRect(200, 38, 200, 200))
        # self.label_14.setStyleSheet("font: 9pt \"FontAwesome\";")
        pix = QPixmap('../pictures/hotel.jpg')
...
#         self.commitAddT.setObjectName("commitAddT")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.tableClient.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "注册时间"))
        self.searchNB.setText(_translate("MainWindow", "立即检索"))
        self.searchName.setPlaceholderText(_translate("MainWindow", "搜索客户姓名"))
